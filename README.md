...
- **Windows:**
  ...
  - [Git](https://git-scm.com/downloads/win) (isn't a GNU toolkit by itself, but
    it conveniently includes a stripped-down immutable version of MSYS2)
...
When working in a POSIX shell environment, remember to use forward slashes (`/`)
as directory separators instead of the Windows-native backslashes (`\`).
